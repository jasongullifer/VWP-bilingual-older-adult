...
mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_ED) * Group_Age + TRIAL_LABEL + WASI.Vocab.Scaled.Score +
           ...
           contrasts = list(displayR = contr.sum(2)/2))
...
### 200 - 600
```{r}
mod = lmer(Eng_Comp.prop ~ word_heard * scale(prop_phondiv_T_ED) * Group_Age + WASI.Vocab.Scaled.Score + TRIAL_LABEL +
...
mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_ED) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + TRIAL_LABEL +
             WASI.Vocab.Scaled.Score + (1 |Participant) + (1|set), 
           data=data_200_600[data_200_600$word_heard == "T" & data_200_600$displayR != "zFD" & 
...
mod = lmer(Eng_Comp.prop ~ word_heard * scale(prop_phondiv_T_ED) * scale(RT_Ratio_En_Fr_Liv_NonLiv) +
             WASI.Vocab.Scaled.Score + TRIAL_LABEL +
             (1 | Participant) + (1 | set), 
...
### 200 - 600
```{r}
mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_FD) * Group_Age + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1  |Participant) + (1 + displayR + Group_Age |set), data=data_200_600[data_200_600$word_heard == "T" & data_200_600$displayR != "zED" & data_200_600$displayR != "zEFD",], contrasts = list(displayR = contr.sum(2)/2))
...
### 600 - 1000
```{r}
mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_FD) * Group_Age + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1 |Participant) + (1 + displayR + Group_Age |set), data=data_600_1000[data_600_1000$word_heard == "T" & data_600_1000$displayR != "zED" & data_600_1000$displayR != "zEFD",], contrasts = list(displayR = contr.sum(2)/2))
...
### 200 - 600
```{r}
mod = lmer(Fr_Comp.prop ~ word_heard * scale(prop_phondiv_T_FD) * Group_Age + WASI.Vocab.Scaled.Score + TRIAL_LABEL + (1 |Participant) + (1 + word_heard + Group_Age |set), data=data_200_600[data_200_600$displayR == "zFD"  ,],)
...
### 600 - 1000
```{r}
mod = lmer(Fr_Comp.prop ~ word_heard * scale(prop_phondiv_T_FD) * Group_Age + WASI.Vocab.Scaled.Score + TRIAL_LABEL + (1 + word_heard |Participant) + (1 + word_heard + Group_Age |set), data=data_600_1000[data_600_1000$displayR == "zFD"  ,],)
...
```{r}
mod = lmer(Click.RT ~ word_heard * scale(prop_phondiv_T_FD) * Group_Age + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1 + word_heard |Participant) + (1 + word_heard + Group_Age |set), data=data_200_1000[data_200_1000$displayR == "zFD"  ,],)
...
```{r}
# 
mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_FD) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1  |Participant) + (1 |set), data=data_200_600[data_200_600$Group_Age =="zO" & data_200_600$word_heard == "T" & data_200_600$displayR != "zED" & data_200_600$displayR != "zEFD",], contrasts = list(displayR = contr.sum(2)/2))

summary(mod)

mod = lmer(Target.prop ~ displayR * scale(prop_phondiv_T_FD) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1 |Participant) + (1 | set), data=data_600_1000[data_600_1000$Group_Age =="zO" & data_600_1000$word_heard == "T" & data_600_1000$displayR != "zED" & data_600_1000$displayR != "zEFD",], contrasts = list(displayR = contr.sum(2)/2))

summary(mod)


# 
mod = lmer(Fr_Comp.prop ~ word_heard * scale(prop_phondiv_T_FD) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + WASI.Vocab.Scaled.Score + TRIAL_LABEL + (1 |Participant) + (1 |set), data=data_200_600[data_200_600$Group_Age =="zO" & data_200_600$displayR == "zFD"  ,],)

summary(mod)

mod = lmer(Fr_Comp.prop ~ word_heard * scale(prop_phondiv_T_FD) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + WASI.Vocab.Scaled.Score + TRIAL_LABEL + (1 |Participant) + (1 |set), data=data_600_1000[data_600_1000$Group_Age =="zO" & data_600_1000$displayR == "zFD"  ,],)

summary(mod)

# 
mod = lmer(Click.RT ~ word_heard * scale(prop_phondiv_T_FD) * scale(RT_Ratio_En_Fr_Liv_NonLiv) + TRIAL_LABEL + WASI.Vocab.Scaled.Score + (1 |Participant) + (1 |set), data=data_200_1000[data_200_1000$Group_Age == "zO" & data_200_1000$displayR == "zFD"  ,],)
